<template>
  <div class="home">
    <head>
      ...
      <!-- Plugins CSS -->
      <link href="/classic-template/html/css/plugins/plugins.css" rel="stylesheet" />
      <!-- REVOLUTION STYLE SHEETS -->
      <link rel="stylesheet" type="text/css" href="/classic-template/html/revolution/css/settings.css" />
      <!-- REVOLUTION LAYERS STYLES -->
      <link rel="stylesheet" type="text/css" href="/classic-template/html/revolution/css/layers.css" />
      <!-- REVOLUTION NAVIGATION STYLES -->
      <link rel="stylesheet" type="text/css" href="/classic-template/html/revolution/css/navigation.css" />
      <link href="/classic-template/html/css/shop-style.css" rel="stylesheet" />
    </head>
    <div
      ...
      <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display: none" data-version="5.4.1">
        <ul>
          ...
          >
            <!-- MAIN IMAGE -->
            <img
              src="/classic-template/html/images/hugging-from-behind.jpg"
              alt=""
            ...
            <!-- LAYER NR. 1- Keep -->
            <div
              class="tp-caption shop-slider-title tp-resizeme"
            ...
            <!-- LAYER NR. 3-Keep -->
            <div
              class="tp-caption shopSlide-caption tp-resizeme"
            ...
            >
              The Social Site For Those With Multiple Sclerosis
            </div>
          </li>
        </ul>
    ...
    <!-- <div
      ...
      style="background-image: url('images/bg8.jpg')"
    >
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            <h1 class="text-uppercase">MS Connect: The Only Social Site For Those With Multiple Sclerosis</h1>
          </div>
        </div>
      </div>
    </div> -->
